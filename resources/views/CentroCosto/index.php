...
<div class="container" ng-controller="centroCostoController">


    <div class="col-xs-12">

        <h4>Gestión de Centros de Costos</h4>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 error" style="margin-top: 5px;">
                                <div class="input-group">
                                    <span class="input-group-addon">Nombre del Centro de Costo: </span>
                                    <input type="text" class="form-control"  name="namecentrocosto" id="namecentrocosto" ng-model="namecentrocosto" placeholder=""
                                           ng-required="true" ng-maxlength="100">
                                </div>
                                <span class="help-block error"
                                      ng-show="formCanal.namecentrocosto.$invalid && formCanal.namecentrocosto.$touched">El nombre del Centro de Costo es requerido</span>
                                <span class="help-block error"
                                      ng-show="formCanal.namecentrocosto.$invalid && formCanal.namecentrocosto.$error.maxlength">La longitud máxima es de 100 caracteres</span>
                            </div>

                            <div class="col-xs-12" style="margin-top: 5px;">
                                <textarea id="observacion" class="form-control" rows="3" ng-model="observacion" placeholder="Observación"></textarea>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="btn-save" ng-click="save();" ng-disabled="formCanal.$invalid">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modalDelete">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Realmente desea eliminar el Centro de Costo: <strong>"{{nom}}"</strong>?</span>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Cancelar <span class="glyphicon glyphicon-ban-circle" aria-hidden="true"></span>
