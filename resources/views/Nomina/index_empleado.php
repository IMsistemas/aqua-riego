                                    ...
                                    <div class="form-group error">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="documentoidentidadempleado" id="documentoidentidadempleado"
                                                   ng-model="documentoidentidadempleado" ng-required="true" ng-minlength="10" ng-pattern="/^([0-9]+)$/" >
                                    ...
                                    <div class="form-group error">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="apellido" id="apellido"
                                                   ng-model="apellido" ng-required="true" ng-maxlength="128"
                                                   ng-keypress="onlyCharasterAndSpace($event);" ng-pattern="/^([a-zA-ZáéíóúñÑ ])+$/">
                                            <span class="help-block error"
                                    ...
                                    <div class="form-group error">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="nombre" id="nombre"
                                                   ng-model="nombre" ng-required="true" ng-maxlength="128" ng-keypress="onlyCharasterAndSpace($event);" ng-pattern="/^([a-zA-ZáéíóúñÑ ])+$/">
                                            <span class="help-block error"
