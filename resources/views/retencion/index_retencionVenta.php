        ...
        <div class="col-xs-12" style="margin-top: 15px;">
            ...
            <div class="col-sm-1 col-xs-12">
                <button type="button" class="btn btn-primary" style="float: right;" ng-click="newForm()"
                        data-toggle="tooltip" data-placement="bottom" title="Crear nueva Retención de Ventas">
            ...
            <table class="table table-responsive table-striped table-hover table-condensed">
                ...
                <tr dir-paginate="item in retencion | orderBy:sortKey:reverse | itemsPerPage:10 " total-items="totalItems" ng-cloak>
                    ...
                    <td  class="text-center">
                        <button type="button" class="btn btn-info btn-sm" ng-click="loadFormPage(item.idretencionventa)">
    ...
    <div ng-show="active=='1'" ng-hide="active=='0'">
        ...
        <form name="formRteCompras" novalidate="">
            ...
            <div class="col-xs-12" style="margin-top: 15px;">
                ...
                <div class="col-sm-4 col-xs-12">
                    <div class="input-group">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Ventas Nro.: </span>
                        ...
                        <angucomplete-alt
                            ...
                            remote-url = "{{API_URL}}retencionVentas/getVentas/"

                            title-field="codigoventa"
                            ...
                            text-searching="Buscando Ventas"
                    ...
                    <div class="container">
                                    ...
                                    <td>
                                        ...
                                        <div class="col-xs-12">
                                            <angucomplete-alt
                                                ...
                                                remote-url = "{{API_URL}}retencionVentas/getCodigos/"
                        ...
                        <div class="col-xs-12">
                            <button type="button" class="btn btn-primary" style="float: right;" ng-click="returnList()"
                                    data-toggle="tooltip" data-placement="bottom" title="Regresar al Registro de Retenciones de Ventas">
                            ...
                            <button type="button" class="btn btn-default" style="float: right;" ng-click=""
                                    data-toggle="tooltip" data-placement="bottom" title="Anular la Retención de la Venta">
                            ...
                            <button type="button" class="btn btn-success" style="float: right;" ng-click="save()" ng-disabled="formRteCompras.$invalid"
                                    data-toggle="tooltip" data-placement="left" title="Guardar la Retención de la Venta" >
