...
<div class="col-xs-12">
			...
			<div class="col-xs-12" style="margin-top: 5px;">
				<div class="input-group">                        
	                ...
	                <input type="text" class="form-control" name="idplancuenta" id="idplancuenta"
                                                       ng-model="bodega.idplancuenta" >
	            </div>
	...
	<div class="col-xs-12">
		<fieldset>
			...
			<div class="col-xs-12" style="margin-top: 5px;">
				<textarea placeholder="Observación" name="observacion" id="observacion" rows="2" cols="80" ng-model="bodega.observacion" ng-maxlength="1024" ng-pattern="/[a-zA-ZáéíóúñÑ0-9. ]+/"></textarea>
				 <span class="help-block error"
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modalConfirmDelete">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" id="btn-save" ng-click="eliminarBodega()">Eliminar</button>
                    </div>
                </div>
            </div>
        </div>
