...
drop index BARRIOAAPORTE_FK;

drop index APORTEJUNTAMODULAR_PK;

drop table APORTEJUNTAMODULAR;
...
drop index DESCUENTOACOBROAGUA_FK;
...
/*==============================================================*/
/* Table: APORTEJUNTAMODULAR                                    */
/*==============================================================*/
create table APORTEJUNTAMODULAR (
   IDAPORTE             SERIAL                 not null,
   IDBARRIO             INT8                 not null,
   VALORANUAL           DECIMAL(9,2)         null,
   PERIODO              DATE                 null,
   constraint PK_APORTEJUNTAMODULAR primary key (IDAPORTE)
);

/*==============================================================*/
/* Index: APORTEJUNTAMODULAR_PK                                 */
/*==============================================================*/
create unique index APORTEJUNTAMODULAR_PK on APORTEJUNTAMODULAR (
IDAPORTE
);

/*==============================================================*/
/* Index: BARRIOAAPORTE_FK                                      */
/*==============================================================*/
create  index BARRIOAAPORTE_FK on APORTEJUNTAMODULAR (
IDBARRIO
);
...
/* Index: CAUDAL_PK                                             */
/*==============================================================*/
create unique index CAUDAL_PK on CAUDAL (
IDCAUDAL
);
...
create table CLIENTE (
   ...
   IDPROFESION          INT8                 null,
   IDACTIVIDAD          INT8                 null,
...
/*==============================================================*/
/* Index: DESCUENTOACOBROAGUA_FK                                */
/*==============================================================*/
create  index DESCUENTOACOBROAGUA_FK on COBROAGUA (
IDDESCUENTO
);
...
/*==============================================================*/
/* Index: BARRIOATOMA_FK                                        */
/*==============================================================*/
create  index BARRIOATOMA_FK on TOMA (
IDBARRIO
);
...
alter table APORTEJUNTAMODULAR
   add constraint FK_APORTEJU_BARRIOAAP_BARRIO foreign key (IDBARRIO)
...
alter table COBROAGUA
   add constraint FK_COBROAGU_DESCUENTO_DESCUENT foreign key (IDDESCUENTO)
...
alter table TOMA
   add constraint FK_TOMA_BARRIOATO_BARRIO foreign key (IDBARRIO)
      references BARRIO (IDBARRIO)
      on delete restrict on update restrict;
